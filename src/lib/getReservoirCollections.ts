...
import { saveCollectionToSupabase } from "@/lib/dataStorage/saveCollections";
 ...
 */
export async function getCollectionData(contractAddress: string) {
  console.log(
  ...
  const collectionData: CollectionDataProps = {
    ...
    last_updated: new Date().toISOString(), // ✅ Atjaunošanas laiks
  };
