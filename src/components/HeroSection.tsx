...
export default function NFTScanSection() {
  ...
  return (
    <section className="container mx-auto max-w-none px-6 lg:px-0">
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div className="relative">
          <Image
            src="/images/nft-scan-preview.png"
      ...
      {/* 🟠 Fona dekorācijas */}
      <div className="absolute top-10 left-0 w-96 h-96 bg-purple-700 rounded-full filter blur-[120px] opacity-30"></div>
