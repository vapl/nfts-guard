      ...
      <div className="container mx-auto flex flex-col md:flex-row px-6 py-12">
        ...
        <nav className="hidden md:block md:w-1/4 md:pr-8 min-w-[260px]">
          <div className="sticky top-24 bg-gray-800 p-6 rounded-lg shadow-md">
            <ul className="space-y-3 text-lg text-gray-300 mb-6 max-w-full text-nowrap">
              {[
              ...
              content: (
                <>
                  ...
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    ...
                    discontinue any aspect of the Services at any time, with or
                    without prior notice. We also reserve the right to modify
                    these Terms to reflect new features, legal requirements, or
                    industry standards. Your continued use of our Services after
                    any updates to these Terms signifies your acceptance of the
                    revised version.
                  </p>
                </>
              ),
              ...
              content: (
                <>
                  ...
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    ...
                    materials that you upload, share, or distribute through our
                  ...
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    ...
                    remove content that we determine, at our sole discretion, to
                    be in violation of these Terms or applicable laws. We also
                    reserve the right to suspend or terminate user accounts that
                    engage in activities that compromise the safety and legality
                    of our platform.
                  </p>
                </>
              ),
              ...
              content: (
                <>
                  ...
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    ...
                    explicit written permission from NFTs Guard. Unauthorized
              ...
              content: (
                <>
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    ...
                    that NFTs Guard is not liable for any damages, losses, or
                  ...
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    ...
                    consequential, special, or punitive damages resulting from:
                  </p>
                  <ul className="list-disc ml-6 text-lg text-gray-300 mb-6 max-w-full">
                    <li>
                    ...
                    <li>
                      ...
                      assessments, risk analyses, or NFT insights provided
                    ...
                    <li>
                      Unauthorized access, cyber-attacks, or security breaches
                      affecting your blockchain wallet or digital assets.
                    </li>
                    <li>
                      Decisions made based on our data analytics or any reliance
                      on automated risk scores or security warnings.
                    </li>
                  </ul>
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    Our total liability to you for any claims, damages, or legal
                    actions shall not exceed the amount you have paid to NFTs
                    Guard, if any, for the use of our Services. If you have not
                    made any payments, our liability is strictly limited to the
              ...
              content: (
                <>
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    ...
                    the right to modify, update, or amend these Terms of Service
                    at any time to reflect changes in our Services, applicable
                    laws, or industry standards. Any modifications will become
                    effective once they are published on our platform.
                  </p>
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    If we make material changes to these Terms, we will provide
                    reasonable notice before the changes take effect.
                  ...
                  <p className="text-lg text-gray-300 mb-6 max-w-full">
                    Your continued use of NFTs Guard after any updates to these
                    Terms will be deemed as acceptance of the modified Terms. If
                    you do not agree with the updated Terms, you must
